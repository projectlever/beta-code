...
$categories = array(
	...
	"Extracurricular" => array("Extracurricular_ID","Tags","Name","Description")
	);
// Set up json
$json = array(
	"Advisor"=>array(),
...
$_SESSION["data"] = $json;
$desc = array("Advisor"=>"`Block`","Course"=>"`Description`","Grant"=>"`Description`","Thesis"=>"`Abstract`","Extracurricular"=>"Description");
