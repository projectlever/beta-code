	...
	<div class="row full-height" style="padding-top:2em">
	  <div class="col-xs-2 col-xs-offset-1 full-height" style="padding-top:4em">
		...
		<span>{{results.grantsNumResults}}</span>
	      ...
	      <li id="Extra_results_count" class="result-type" ng-click="showResource('Extra')" ng-class="{'selected-result-type':display=='extra','result-type':display!='extra'}">
		<img src="/images/LittleGrantRed.png" width="25">
		Extracurriculars
		<span>{{results.extraNumResults}}</span>
	      </li>
	    </ul>
